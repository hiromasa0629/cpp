...
/*   Updated: 2022/08/22 17:49:13 by hyap             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap Destructing..." << std::endl;
}
...
{
	std::cout << "ClapTrap [" << this->get_name() << "] HP: " << this->get_hp() << ", ENERGY: " << this->get_energy() << std::endl;
}
